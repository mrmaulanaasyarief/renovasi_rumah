...
class SupplierModel extends Model
{
    ...
    public function insertData(){
        ...
        $hasil = $this->db->query("INSERT INTO supplier SET nama_supplier = ?, alamat_supplier=?, telepon_supplier=?, jenis_material=? ", array($nama, $alamat, $telp_supplier, $jenis_material));
        return $hasil;
    }
    ...
    public function updateData(){
        ...
        $telp_supplier = $_POST['telepon_supplier'];
        $jenis_material = $_POST['jenis_material'];
        $hasil = $this->db->query("UPDATE supplier SET nama_supplier = ?, alamat_supplier=?, telepon_supplier=?, jenis_material=? WHERE id_supplier =? ", array($nama, $alamat, $telp_supplier, $jenis_material, $id));
        return $hasil;
    }
