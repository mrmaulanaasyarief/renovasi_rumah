...
class PenggajianModel extends Model
{
    ...
    public function insertData(){
        ...
        $tgl_penggajian = $_POST['tanggal_penggajian'];
        ...
        $sql = "INSERT INTO penggajian_pegawai SET jumlah_hari=?, gaji=?, total_gaji=?, id_pegawai=?, tanggal_penggajian=?
        ";
        $hasil = $this->db->query($sql, array($jumlah_hari,$gaji,$total_gaji,$id,$tgl_penggajian));

        $sql = "SELECT * FROM penggajian_pegawai WHERE jumlah_hari=? AND gaji=? AND total_gaji=? AND id_pegawai=? AND tanggal_penggajian=?
        ";
        $hasil = $this->db->query($sql, array($jumlah_hari,$gaji,$total_gaji,$id,$tgl_penggajian));
