...
class Penggajian extends BaseController
{
    ...
    public function index(){
        ...
        echo view('penggajian/DaftarPegawai', $data);
    }

    //input pemesanan
    public function inputpenggajian($id_pegawai){
        //tambahkan pengecekan login
        //if(!isset($_SESSION['nama'])){
        //    return redirect()->to(base_url('home')); 
        //}
        ...
        $data['telp_pegawai'] = $telp_pegawai;
            ...
            echo view('HeaderBootstrap');
            echo view('SidebarBootstrap');
            echo view('penggajian/Inputpenggajian', $data);        
    }
       ...
       //tambahkan pengecekan login
        ...
        if(isset($_POST['jumlah_hari']) and isset($_POST['gaji'])){
            ...
            if (! $this->validate(
                ...
                echo view('HeaderBootstrap');
                echo view('SidebarBootstrap');
                echo view('penggajian/Inputpenggajian',[
                ...
                $hasil = $this->PenggajianModel->insertData();
                ...
                $hasil = $this->PenggajianModel->getAll();

                $data['pegawai'] = $hasil;  

                echo view('HeaderBootstrap');
                echo view('SidebarBootstrap');
                echo view('penggajian/ListPenggajian', $data);
