...
class Pencatatan extends BaseController
{
    ...
    public function index(){
        ...
        echo view('pencatatan/DaftarPegawai', $data);
    }

    //input pemesanan
    public function inputpencatatan($id_pegawai){
        //tambahkan pengecekan login
        //if(!isset($_SESSION['nama'])){
        //    return redirect()->to(base_url('home')); 
        //}
        ...
        $data['telp_pegawai'] = $telp_pegawai;
            ...
            echo view('HeaderBootstrap');
            echo view('SidebarBootstrap');
            echo view('pencatatan/Inputpencatatan', $data);        
    }
       ...
       //tambahkan pengecekan login
        ...
        if(isset($_POST['jumlah_hari']) and isset($_POST['gaji'])){
            ...
            if (! $this->validate(
                ...
                echo view('HeaderBootstrap');
                echo view('SidebarBootstrap');
                echo view('pencatatan/Inputpencatatan',[
                ...
                $hasil = $this->PencatatanModel->getAll();

                $data['pegawai'] = $hasil;  

                echo view('HeaderBootstrap');
                echo view('SidebarBootstrap');
                echo view('pencatatan/ListPencatatan', $data);
