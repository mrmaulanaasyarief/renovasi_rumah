<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Penggajian Pegawai</h1>
                ...
                if(fmod($i,3)==0){
                  ?> 
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title"><?= $row['nama_pegawai']." (ID = ".$row['id_pegawai'].")";?>
                                    </h5>
                                    <p class="card-text"><?= $row['alamat_pegawai'].' ('.$row['telp_pegawai'].' ('.$row['jenis_pegawai'].')';?>
                                    </p>
                                    
                                    <a href="<?= base_url('penggajian/InputPenggajian/'.$row['id_pegawai'].'/'.$row['nama_pegawai']) ?>" class="btn btn-primary">Penggajian Pegawai</a>
                                </div>
                            </div>
                        </div>
                        <p>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/js/bootstrap.min.js" integrity="sha384-oesi62hOLfzrys4LxRF63OJCXdXDipiYWBnvTl9Y9/TRlw5xlKIEHpNyvvDShgf/" crossorigin="anonymous"></script>
      ...
      <script>
          function deleteConfirm(url){
              url2 = "<?= base_url('pegawai/DaftarPegawai') ?>"; //diisi dengan halaman ini
