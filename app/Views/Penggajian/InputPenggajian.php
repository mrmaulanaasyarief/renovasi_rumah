<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Input Penggajian Pegawai: <?= $nama_pegawai;?></h1>
      ...
      ?>
        <div class="row">
        <?= form_open('penggajian/prosesInput') ?>
        
                <div class="mb-3">
                    <label for="tanggal_penggajian">Tanggal Penggajian</label>
                    <input type="date" class="form-control" id="tanggal_penggajian" name="tanggal_penggajian" value="<?= set_value('tanggal_penggajian')?>" placeholder="Diisi dengan tanggal penggajian">
                </div>
                <div class="mb-3">
