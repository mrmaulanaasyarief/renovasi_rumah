                ...
                if(fmod($i,3)==0){
                  ?> 
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title"><?= $row['nama_alat']." (ID = ".$row['id_alat'].")";?></h5>
                                    <p class="card-text"><?= $row['alamat'].' ('.$row['telepon'].')';?></p>
                                    <a href="#" class="btn btn-primary">Lihat Detail Alat</a>
                                    <a href="<?= base_url('alat/editalat/'.$row['id_alat']) ?>" class="btn btn-success">Ubah</a>
                                    <a onclick="deleteConfirm('<?php echo base_url('alat/deletealat/'.$row['id_alat']) ?>')" href="#" class="btn btn-danger" role="button" aria-pressed="true">Hapus</a>
                                </div>
                            </div>
                        </div>
                        <p>
      ...
      ?>
            ...
            <div class="row">
              <div class="col">
                  <div class="card">
                    <div class="card-body">
                    <a href="<?= base_url('alat') ?>" class="btn btn-warning" id="tmbh">Tambah Data Alat</a>
                    </div>
                  </div>
              </div>
            </div>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/js/bootstrap.min.js" integrity="sha384-oesi62hOLfzrys4LxRF63OJCXdXDipiYWBnvTl9Y9/TRlw5xlKIEHpNyvvDShgf/" crossorigin="anonymous"></script>
      ...
      <script>
          function deleteConfirm(url){
              url2 = "<?= base_url('alat/daftaralat') ?>"; //diisi dengan halaman ini
