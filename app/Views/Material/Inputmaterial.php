      ...
      ?>
        ...
        <?= form_open('material') ?>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="namamaterial" name="namamaterial" value="<?= set_value('namamaterial')?>" placeholder="Diisi dengan nama material">
                </div>
                <div class="mb-3">
                <label for="jenismaterial" class="form-label">Jenis Material</label>
                    <select class="form-select" aria-label="Default select example" name="jenismaterial">
                        <?php
                            $alt=""; $bhn = ""; 
                            if(set_value('jenismaterial')=='Alat'){$alt="selected";}
                            else{$bhn="selected";}
                        ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="harga" name="harga" value="<?= set_value('harga')?>" placeholder="Diisi dengan Harga">
                </div>
