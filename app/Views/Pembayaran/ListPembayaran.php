<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Data Pembayaran Renovasi <?=$nama.','.$jenis_renovasi?></h1>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="card-body">
                <p class="card-text ">Harga Renovasi = <?=$harga_deal?><br>
                Total Bayar  = <?=$totalbayar?><br>
                Sisa Bayar = <b><?=$sisa_bayar?></b>
                </p>
                <a href="<?= base_url('pembayaran/inputpembayaran/'.$id_pesan.'/'.$nama) ?>" class="btn btn-warning" id="tmbh">Tambah Data Bayar</a>
            </div>
            </div>
        </div>
    </div>
