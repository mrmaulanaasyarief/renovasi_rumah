<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Pembayaran Supplier</h1>
                ...
                if(fmod($i,3)==0){
                  ?> 
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title"><?= $row['nama']." (ID = ".$row['id_supplier'].")";?>
                                    </h5>
                                    <p class="card-text"><?= $row['alamat'].' ('.$row['telp_supplier'].')';?>
                                    </p>
                                    
                                    <a href="<?= base_url('Pembayaran/InputPembayaran'.$row['id_supplier'].'/'.$row['nama']) ?>" class="btn btn-primary">Bayar Supplier</a>
                                </div>
                            </div>
                        </div>
                        <p>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><?= $row['alamat'].' ('.$row['no_hp'].')';?>
                                    </p>
                                    <a href="<?= base_url('Pembayaran/InputPembayaran/'.$row['id_supplier'].'/'.$row['nama']) ?>" class="btn btn-primary">Bayar Supplier</a>
