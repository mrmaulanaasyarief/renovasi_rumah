        ...
        <?= form_open('supplier/editsupplierproses') ?>
            ...
            <input type="hidden" id="id_supplier" name="id_supplier" value="<?= $id?>">
                ...
                <div class="mb-3">
                    ...
                    <?php
                        //jika set value telepon tidak kosong maka isi $telepon diganti dengan isian dari user
                        if(strlen(set_value('harga_material'))>0){
                          $harga_material = set_value('harga_material');
                        }
                
                    ?>
                    <input type="text" class="form-control" id="harga_materialr" name="harga_material" value="<?= $harga_material?>" placeholder="Diisi dengan harga material">
                </div>
