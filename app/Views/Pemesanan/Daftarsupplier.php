<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Pesanan Supplier</h1>
                ...
                if(fmod($i,3)==0){
                  ?> 
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title"><?= $row['nama_supplier']." (ID = ".$row['id_supplier'].")";?>
                                    </h5>
                                    <p class="card-text"><?= $row['alamat_supplier'].' ('.$row['jenis_material'].')';?>
                                    </p>
                                    
                                    <a href="<?= base_url('Pemesanan/InputPemesanan/'.$row['id_supplier'].'/'.$row['nama_supplier']. "/".$row['harga_material'] ) ?>" class="btn btn-primary">Pesan Supplier</a>
                                </div>
                            </div>
                        </div>
                        <p>
